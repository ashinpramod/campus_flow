...
class AdminControlledStudentList extends StatelessWidget {
  const AdminControlledStudentList({super.key});
...
//-----------------------------------------------------------------------confirmation dialog
  void _showDeleteConfirmationDialog(BuildContext context, student) {
    showDialog(
      context: context,
      builder: (context) {
